...
def make_demo_config(num_layers: int) -> DeepseekV4Config:
    ...
    per-layer between 4 and 128. We shrink everything for CPU fit.
    """
    if num_layers % 2 != 0:
...
def main() -> None:
    ...
    cfg = make_demo_config(num_layers=args.num_layers)
